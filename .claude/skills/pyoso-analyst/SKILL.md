...
1. **Pick the right table from the registry**
   - Start from [`models/README.md`](../../../models/README.md) for the inventory.
   - Use [`docs/guides/currentai-queries.md`](../../../docs/guides/currentai-queries.md) for query conventions and caveats.
   - Use [`docs/guides/currentai-notebooks.md`](../../../docs/guides/currentai-notebooks.md) for marimo notebook structure/style.
