...
type MessageUpdateRequestOptions = {
	...
	// Open-web search grounding for this turn (composer globe toggle): query +
	// numbered sources + evidence block + retrieval date. Sent to the server,
	// which grounds the answer on the evidence and persists the sources.
