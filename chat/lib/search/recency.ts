// Lightweight, no-LLM heuristic for "this question wants current/外部 info the
// model can't know from training" — used to surface the "search open sources?"
// affordance. Deliberately conservative: it only *offers* search; the user
// always decides, and a manual search button is always available regardless.
