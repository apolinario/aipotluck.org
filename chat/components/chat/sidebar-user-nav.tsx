      ...
      <SidebarMenuItem>
        <DropdownMenu>
          ...
          >
            ...
            {/* Sign-in is deferred for the guest-only alpha, so guests get no
                "Login to your account" item. Sign out stays for real accounts
                (none in the alpha, but correct when accounts arrive). */}
            {!isGuest && (
              <>
                <DropdownMenuSeparator />
